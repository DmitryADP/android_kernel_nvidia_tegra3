...
static const struct tegra30_emc_table nabi2_emc_tables_elpida[] = {
#if 1
	{
		0x32,       /* Rev 3.2 */
...
static const struct tegra30_emc_table nabi2_emc_tables_nanya[]= {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra30_emc_table nabi2_emc_tables_samsung[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra30_emc_table nabi2_emc_tables_micron[] = {
	#if 1
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
...
static const struct tegra30_emc_table nabi2_xd_emc_tables_elpida[] = {
#if 1
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
...
static const struct tegra30_emc_table nabi2_xd_emc_tables_nanya[]= {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra30_emc_table nabi2_xd_emc_tables_samsung[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra30_emc_table nabi2_xd_emc_tables_micron[] = {
	#if 1
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
...
static const struct tegra30_emc_table birch_emc_tables_elpida[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra30_emc_table birch_emc_tables_hynix[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static struct tegra30_emc_pdata nabi2_emc_chip_elpida = {
	.description = "nabi2_elpida",
	.tables = (struct tegra30_emc_table *)nabi2_emc_tables_elpida,
	.num_tables = ARRAY_SIZE(nabi2_emc_tables_elpida)
};

static struct tegra30_emc_pdata nabi2_emc_chip_nanya = {
	.description = "nabi2_nanya",
	.tables = (struct tegra30_emc_table *)nabi2_emc_tables_nanya,
	.num_tables = ARRAY_SIZE(nabi2_emc_tables_nanya)
};

static struct tegra30_emc_pdata nabi2_emc_chip_samsung = {
	.description = "nabi2_samsung",
	.tables = (struct tegra30_emc_table *)nabi2_emc_tables_samsung,
	.num_tables = ARRAY_SIZE(nabi2_emc_tables_samsung)
};

static struct tegra30_emc_pdata nabi2_emc_chip_micron = {
	.description = "nabi2_micron",
	.tables = (struct tegra30_emc_table *)nabi2_emc_tables_micron,
	.num_tables = ARRAY_SIZE(nabi2_emc_tables_micron)
};

static struct tegra30_emc_pdata nabi2_xd_emc_chip_micron = {
	.description = "nabi2_xd_micron",
	.tables = (struct tegra30_emc_table *)nabi2_xd_emc_tables_micron,
	.num_tables = ARRAY_SIZE(nabi2_xd_emc_tables_micron)
};

static struct tegra30_emc_pdata nabi2_xd_emc_chip_samsung = {
	.description = "nabi2_xd_samsung",
	.tables = (struct tegra30_emc_table *)nabi2_xd_emc_tables_samsung,
	.num_tables = ARRAY_SIZE(nabi2_xd_emc_tables_samsung)
};

static struct tegra30_emc_pdata nabi2_xd_emc_chip_nanya = {
	.description = "nabi2_xd_nanya",
	.tables = (struct tegra30_emc_table *)nabi2_xd_emc_tables_nanya,
	.num_tables = ARRAY_SIZE(nabi2_xd_emc_tables_nanya)
};

static struct tegra30_emc_pdata nabi2_xd_emc_chip_elpida = {
	.description = "nabi2_xd_elpida",
	.tables = (struct tegra30_emc_table *)nabi2_xd_emc_tables_elpida,
	.num_tables = ARRAY_SIZE(nabi2_xd_emc_tables_elpida)
};

static struct tegra30_emc_pdata birch_emc_chip_elpida = {
	.description = "birch_elpida",
	.tables = (struct tegra30_emc_table *)birch_emc_tables_elpida,
	.num_tables = ARRAY_SIZE(birch_emc_tables_elpida)
};

static struct tegra30_emc_pdata birch_emc_chip_hynix = {
	.description = "birch_hynix",
	.tables = (struct tegra30_emc_table *)birch_emc_tables_hynix,
	.num_tables = ARRAY_SIZE(birch_emc_tables_hynix)
};
...
struct tegra30_emc_pdata *emc_platdata = NULL;
	...
	if(mem_selecter==0){
		...
		{
			emc_platdata = &nabi2_xd_emc_chip_micron;
		}
		else
		{
			emc_platdata = &nabi2_emc_chip_micron;
		}
	...
	if(machine_is_nabi2_xd()||machine_is_n1010() || machine_is_itq700() 
		...
		||machine_is_wikipad()||machine_is_ns_14t004())
		{
			emc_platdata = &nabi2_xd_emc_chip_elpida;
		}
		else if(machine_is_birch())
		{
			emc_platdata = &birch_emc_chip_elpida;
        pr_err("kai_emc_init:==================> device is birch\n");
		}
		else
		{
			emc_platdata = &nabi2_emc_chip_elpida;
		}
		...
		||machine_is_qc750()||machine_is_n750()
		||machine_is_wikipad()||machine_is_ns_14t004()){
			emc_platdata = &nabi2_xd_emc_chip_nanya;
			pr_err("kai_emc_init:======== use nanya ddr3\n");
		}
		else if(machine_is_birch())
		{
			emc_platdata = &birch_emc_chip_hynix;
        pr_err("kai_emc_init:==================> device is birch\n");
        pr_err("kai_emc_init:==================> use  hynix ddr3\n");
		}
		else{
			emc_platdata = &nabi2_emc_chip_nanya;
		pr_err("kai_emc_init:==================> use  nanya ddr3\n");
		}
	}
