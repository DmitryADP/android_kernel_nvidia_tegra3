...
static struct tegra30_emc_pdata *kai_get_emc_platdata(int hw_ramcode) {
	switch (hw_ramcode) {
	case 0: /* Micron */
		printk("Hardware ramcode is %d; Micron RAM\n", hw_ramcode);
		return &qc750_emc_chip_micron;
	case 1: /* Samsung*/
		printk("Hardware ramcode is %d; Samsung RAM\n", hw_ramcode);
		return &qc750_emc_chip_samsung;
	case 2: /* Elpida */
		printk("Hardware ramcode is %d; Elpida RAM\n", hw_ramcode);
		return &qc750_emc_chip_elpida;
	case 3:  /* Nanya */
		printk("Hardware ramcode is %d; Nanya RAM\n", hw_ramcode);
...
int __init kai_emc_init(void) {
	int hw_ramcode;
	hw_ramcode = qc750_get_hw_ramcode();
